...
public class SpeechUtils {
    ...
    private SpeechUtils() {
        tts = new TextToSpeech(CjApplication.getInstance(), new TextToSpeech.OnInitListener() {
            @Override
    ...
    public void speak(int resId) {
        tts.speak(CjApplication.getInstance().getString(resId), TextToSpeech.QUEUE_ADD, null);
    }
