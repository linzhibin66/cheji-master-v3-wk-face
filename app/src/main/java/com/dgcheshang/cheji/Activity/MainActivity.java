...
public class MainActivity extends BaseInitActivity  implements View.OnClickListener{
    ...
    Spinner sp_carcolor,sp_carnumber;
        Button bt_sure,bt_cancel,bt_have_set,bt_init,bt_goout;
    ...
    private void initView() {
        ...
        bt_goout = (Button) findViewById(R.id.bt_goout);//跳回系统
        ...
        bt_goout.setOnClickListener(this);
    }
    ...
    protected void onNewIntent(Intent intent) {
        ...
        if (NfcAdapter.ACTION_NDEF_DISCOVERED.equals(intentActionStr)// NDEF类型
            ...
            String  cardNo = MessageUtil.bytesToHexString(bytesId).toUpperCase();
                ...
                bundle.putString("adminuid",cardNo);
                msg.setData(bundle);
